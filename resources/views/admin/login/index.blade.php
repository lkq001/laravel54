...
<head>
    ...
    <link href="{{ asset('style/admin-login') }}/iconfont/style.css" type="text/css" rel="stylesheet">
    <style>
        body {
            color: #fff;
            font-family: "微软雅黑";
        ...
        /*把整个屏幕真正撑开--而且能自己实现居中*/
        .main_content {
            background: url("{{ asset('style/admin-login') }}/images/main_bg.png") repeat;
            margin-left: auto;
            margin-right: auto;
            text-align: left;
            float: none;
...
<body style="background:url('{{ asset('style/admin-login') }}/images/bg.jpg') no-repeat;">
